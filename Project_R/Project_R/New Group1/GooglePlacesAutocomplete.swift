...
//        Alamofire.request(.GET,"https://maps.googleapis.com/maps/api/place/autocomplete/json",
//                          parameters: [
//                            "input": searchString,
...
//           let urlTo = "https://maps.googleapis.com/maps/api/place/autocomplete/json"
